...
public class BidConst {
	 ...
	 * 发送手机验证码的间隔时间
	 */
	public static final long SEND_VERIFYCODE_INTERVAL = 90;//秒
	/**
	 * 手机验证码的有效时间
	 */
	public static final int VERIFYCODE_VAILDATE_SECOND = 180;//秒
	/**
	 * 验证邮箱的有效期
	 */
	 ...
	 * 存储图片的公共文件夹地址
	 */
	public static final String PUBLIC_IMG_SHARE_PATH="/Users/liuxiaoming/Documents/picture";
