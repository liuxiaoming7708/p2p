...
import com.payease.p2p.business.util.DecimalFormatUtil;
...
import static com.payease.p2p.base.util.BidConst.*;
...
public class BidRequest extends BaseDomain {
	...
	public BigDecimal getPersent() {
		return this.currentSum.divide(bidRequestAmount, BidConst.DISPLAY_SCALE,
