...
<script type="text/javascript">
	$(function() {
		...
		$(".auditClass").click(function(){
            ...
            $("#myModal [name=description]").html(data.description);
		      ...
		      <div class="modal-body">
		      	<form class="form-horizontal" id="editform" method="post" action="/bidrequest_publishaudit.do">
					<fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="totalRewardAmount">借款描述</label>
                            <div class="col-sm-6">
                                <label class="form-control" name="description"></label>
                            </div>
                        </div>
						<div class="form-group">
